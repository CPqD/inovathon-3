...
class blockchain():
    ...
    def hello_json():
        ...
        response = requests.post(
            'http://127.0.0.1/anything', data={'key': 'value'})
        print(response.content)


    @staticmethod
    def get_all_cattle(producer_id, jwt):
        ...
        response = requests.get(
            url, headers={"Authorization": "Bearer " + jwt}, params=payload)
    ...
    @staticmethod
    def create_cattle(producer_id, race, father, mother, weight, jwt):
